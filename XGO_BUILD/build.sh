...
xgo -targets=android/386,android/arm,android/arm64,linux/amd64 -deps=https://github.com/jedisct1/libsodium/releases/download/1.0.11/libsodium-1.0.11.tar.gz -depsargs='CFLAGS=-Os' -out="geph-$(git describe --always)" -ldflags='-s -w' ../
#sudo chown builder *
